...
def train():
    ...
    stepvalues_VOC = (100000, 130000, 160000)  # (80000,100000,120000)
    ...
    for iteration in range(start_iter, max_iter):
        ...
        if iteration<=130000 and (iteration == 0 or iteration % 10000 == 0):
            print('Saving state, iter:', iteration)
            torch.save(net.state_dict(), 'weights/ssd512_2_VOC_' +
                       repr(iteration) + '.pth')
        elif (iteration>130000) and  iteration % 2000 == 0 :
            print('Saving state, iter:', iteration)
            torch.save(net.state_dict(), 'weights/ssd512_2_VOC_' +
                       repr(iteration) + '.pth')
